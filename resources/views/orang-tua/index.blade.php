            ...
            <table class="table table-bordered" id="orangTuaTable">
                ...
                <tbody>
                    @foreach($data as $index => $item)
                        @php
                            $lengkapOrtu =
                                $item->nama_ayah && $item->nik_ayah && $item->tahun_lahir_ayah && $item->pendidikan_ayah && $item->pekerjaan_ayah && $item->penghasilan_ayah
                                &&
                                $item->nama_ibu && $item->nik_ibu && $item->tahun_lahir_ibu && $item->pendidikan_ibu && $item->pekerjaan_ibu && $item->penghasilan_ibu;
                        @endphp
