                ...
                <tbody>
                    @foreach($kompetensiKhusus as $index => $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('kompetensi-khusus-ptk.edit', ['kompetensi_khusus_ptk' => $item->kompetensi_khusus_id]) }}"
    ...
    @else
                ...
                <tbody>
                    @foreach($kompetensiKhusus as $index => $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('kompetensi-khusus-ptk.show', $item->ptk_id) }}" class="btn btn-sm btn-no-border">
                                    <img src="{{ asset('images/view.png') }}" alt="Lihat Kompetensi Khusus" style="width:20px; height:20px;">
                                </a>
                                <a href="{{ route('kompetensi-khusus-ptk.create', ['ptk_id' => $item->ptk_id]) }}" class="btn btn-sm btn-no-border">
        ...
        <script>
            document.getElementById('search').addEventListener('keyup', function() {
                ...
                let rows = document.querySelectorAll('#kompetensiKhususTable tbody tr');
