                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('tunjangan.show', $item->ptk_id) }}" class="btn btn-sm btn-no-border">
                            <img src="{{ asset('images/view.png') }}" alt="Lihat Data Tunjangan" style="width:20px; height:20px;">
                        </a>
                        <a href="{{ route('tunjangan.create', ['ptk_id' => $item->ptk_id]) }}" class="btn btn-sm btn-no-border">
                            <img src="{{ asset('images/tambah2.png') }}" alt="Tambah Data Tunjangan" style="width:20px; height:20px;">
                        </a>
                    </td>
                </tr>
                @endforeach
