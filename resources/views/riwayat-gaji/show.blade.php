...
<div class="container">
        ...
        <table class="table table-bordered" id="riwayatGajiTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route($prefix.'riwayat-gaji.edit', $item->id) }}"
                           class="btn btn-sm btn-no-border">
                            <img src="{{ asset('images/edit.png') }}"
                                 alt="Edit Riwayat Gaji"
                                 style="width:20px; height:20px;">
                        </a>

                        <form action="{{ route($prefix.'riwayat-gaji.destroy', $item->id) }}"
    ...
    <a href="{{ route($prefix.'riwayat-gaji.index') }}" class="btn btn-secondary mt-3">Kembali</a>
