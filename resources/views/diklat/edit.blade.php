...
<div class="container">
    <h1 class="mb-4">Edit Diklat PTK</h1>

    <form action="{{ route($prefix . '.diklat.update', $diklat->id) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="penyelenggara" class="form-control"
                        value="{{ $diklat->penyelenggara }}" required>
                </div>

                <div class="mb-3">
                    <label>Tahun</label>
                    <input type="number" name="tahun" class="form-control"
                        value="{{ $diklat->tahun }}" required>
                </div>
