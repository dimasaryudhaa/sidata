...
<div class="container">
    ...
    <form action="{{ route('riwayat-jabatan-fungsional.update', $riwayatJabatanFungsional->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ $ptk->nama_lengkap ?? $riwayatJabatanFungsional->ptk->nama_lengkap }}" readonly>
                    <input type="hidden" name="ptk_id" value="{{ $ptk->id ?? $riwayatJabatanFungsional->ptk_id }}">
                </div>
