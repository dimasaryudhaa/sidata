...
<div class="container">
    ...
    @else
        ...
        const tbody = document.querySelector('#tugasTambahanTable tbody');
        ...
        searchInput.addEventListener('keyup', function () {
            ...
            fetch(`/{{ $isAdmin ? 'admin' : 'ptk' }}/tugas-tambahan/search?q=` + query)
                .then(res => res.json())
                .then(data => {
                    tbody.innerHTML = '';
                        ...
                        tbody.innerHTML += `
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/{{ $isAdmin ? 'admin' : 'ptk' }}/tugas-tambahan/${item.ptk_id}"
                                    class="btn btn-sm btn-no-border">
                                        <img src="/images/view.png" style="width:20px; height:20px;">
                                    </a>

                                    <a href="/{{ $isAdmin ? 'admin' : 'ptk' }}/tugas-tambahan/create?ptk_id=${item.ptk_id}"
                                    class="btn btn-sm btn-no-border">
                                        <img src="/images/add.png" style="width:20px; height:20px;">
                                    </a>
