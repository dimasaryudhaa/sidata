...
<div class="container">
    ...
    <form action="{{ route($prefix.'tugas-tambahan.store') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="jabatan_ptk" class="form-control"
                           placeholder="Contoh: Kepala Perpustakaan" required>
                </div>
                <div class="mb-3">
                    <label>Prasarana</label>
                    <input type="text" name="prasarana" class="form-control"
                           placeholder="Isi jika Kepala Perpustakaan/Lab/Bengkel">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="nomor_sk" class="form-control"
                           placeholder="Minimal 10 digit" required>
                </div>
                <div class="mb-3">
        ...
        <div class="d-flex justify-content-start mt-3">
            <a href="{{ route($prefix.'tugas-tambahan.index') }}" class="btn btn-secondary me-2">Kembali</a>
