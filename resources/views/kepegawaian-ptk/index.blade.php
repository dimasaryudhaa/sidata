            ...
            <tbody>
                @foreach($data as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('kepegawaian-ptk.edit', ['kepegawaian_ptk' => $item->ptk_id]) }}" class="btn btn-sm btn-no-border">
                                <img src="{{ asset('images/edit.png') }}" alt="Tambah/Edit Kepegawaian" style="width:20px; height:20px;">
                            </a>

                            @if($item->kepegawaian_id ?? false)
                                <form action="{{ route('kepegawaian-ptk.destroy', $item->kepegawaian_id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
