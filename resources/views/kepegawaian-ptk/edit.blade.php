...
<div class="container">
    ...
    <form action="{{ $data->id ? route('kepegawaian-ptk.update', $data->id) : route('kepegawaian-ptk.store') }}" method="POST">
        @csrf
        @if($data->id)
            @method('PUT')
        @endif
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    <label>NIP</label>
                    <input type="text" name="nip" class="form-control" maxlength="18" value="{{ old('nip', $data->nip) }}">
                </div>

                <div class="mb-3">
                    <label>NIY/NIGK</label>
                    <input type="text" name="niy_nigk" class="form-control" value="{{ old('niy_nigk', $data->niy_nigk) }}">
                </div>

                <div class="mb-3">
                    <label>NUPTK</label>
                    <input type="text" name="nuptk" class="form-control" value="{{ old('nuptk', $data->nuptk) }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="sk_pengangkatan" class="form-control" value="{{ old('sk_pengangkatan', $data->sk_pengangkatan) }}">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="date" name="tmt_pengangkatan" class="form-control" value="{{ old('tmt_pengangkatan', $data->tmt_pengangkatan) }}">
                </div>
                ...
                <div class="mb-3">
                    <label>SK CPNS</label>
                    <input type="text" name="sk_cpns" class="form-control" value="{{ old('sk_cpns', $data->sk_cpns) }}">
                </div>

                <div class="mb-3">
                    <label>TMT PNS</label>
                    <input type="date" name="tmt_pns" class="form-control" value="{{ old('tmt_pns', $data->tmt_pns) }}">
                </div>

                <div class="mb-3">
                    <label>Pangkat/Golongan</label>
                    <input type="text" name="pangkat_golongan" class="form-control" value="{{ old('pangkat_golongan', $data->pangkat_golongan) }}">
                </div>
                ...
                <div class="d-flex align-items-end gap-2">
                    <div class="flex-grow-1">
                        ...
                        <input type="text" name="kartu_pegawai" class="form-control" value="{{ old('kartu_pegawai', $data->kartu_pegawai) }}">
                    </div>

                    <div class="flex-grow-1">
                        <label>Kartu Keluarga</label>
                        <input type="text" name="kartu_keluarga" class="form-control" value="{{ old('kartu_keluarga', $data->kartu_keluarga) }}">
                    </div>
                </div>
            </div>
        </div>
        <div class="d-flex justify-content-start mt-3">
            <a href="{{ route('kepegawaian-ptk.index') }}" class="btn btn-secondary me-2">Kembali</a>
