...
<div class="container">
    ...
    <form action="{{ route($prefix . '.riwayat-jabatan.update', $riwayatJabatan->id) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control"
                           value="{{ $ptk->nama_lengkap ?? $riwayatJabatan->ptk->nama_lengkap }}"
                           readonly>

                    <input type="hidden" name="ptk_id"
                           value="{{ $ptk->id ?? $riwayatJabatan->ptk_id }}">
                </div>

                <div class="mb-3">
                    <label>Jabatan PTK</label>
                    <input type="text" name="jabatan_ptk" class="form-control"
                           value="{{ $riwayatJabatan->jabatan_ptk }}" required>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="sk_jabatan" class="form-control"
                           value="{{ $riwayatJabatan->sk_jabatan }}" required>
                </div>

                <div class="mb-3">
                    <label>TMT Jabatan</label>
                    <input type="date" name="tmt_jabatan" class="form-control"
                           value="{{ $riwayatJabatan->tmt_jabatan }}" required>
                </div>
