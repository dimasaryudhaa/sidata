            ...
            <tbody>
                ...
                <tr @if($isAdmin) data-rombel="{{ $item->rombel_id }}" @endif>
                    ...
                    @if($isSiswa)
                        ...
                        <td>{{ $item->no_kartu ?? '-' }}</td>
                        <td>{{ $item->nama_di_kartu ?? '-' }}</td>

                        <td>
                            <a href="{{ route($prefix.'kesejahteraan-siswa.edit', $item->id) }}"
                               class="btn btn-sm btn-no-border">
                                <img src="{{ asset('images/edit.png') }}" style="width:20px;height:20px;">
                            </a>

                            <form action="{{ route($prefix.'kesejahteraan-siswa.destroy', $item->id) }}"
                    ...
                    @else
                        ...
                        <td>{{ $item->jumlah_kesejahteraan }}</td>

                        <td>
                            <a href="{{ route($prefix.'kesejahteraan-siswa.show', $item->siswa_id) }}"
                               class="btn btn-sm btn-no-border">
                                <img src="{{ asset('images/view.png') }}" style="width:20px;height:20px;">
                            </a>

                            <a href="{{ route($prefix.'kesejahteraan-siswa.create', ['siswa_id' => $item->siswa_id]) }}"
                               class="btn btn-sm btn-no-border">
