...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\PKL\project\sidata\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\PKL\\project\\sidata\\public\\storage',
...
'generated::9B01Lgs00eAnYtX2','generated::WbTGJLspr7kSU2la','login','generated::49N6rXiGZsFgrJwO','logout',
'register','generated::77BbnjjVNp3tU6XI','password.request','password.email','password.reset',
'password.update','password.confirm','generated::DCRWENxcPgN32PMj','home','profile.index',
'profile.create','profile.store','profile.show','profile.edit','profile.update',
'profile.destroy','siswa.index','siswa.create','siswa.store','siswa.show',
'siswa.edit','siswa.update','siswa.destroy','akun-siswa.index','akun-siswa.create',
'akun-siswa.store','akun-siswa.show','akun-siswa.edit','akun-siswa.update','akun-siswa.destroy',
'dokumen-siswa.index','dokumen-siswa.create','dokumen-siswa.store','dokumen-siswa.show','dokumen-siswa.edit',
'dokumen-siswa.update','dokumen-siswa.destroy','kontak-siswa.index','kontak-siswa.create','kontak-siswa.store',
'kontak-siswa.show','kontak-siswa.edit','kontak-siswa.update','kontak-siswa.destroy','periodik.index',
'periodik.create','periodik.store','periodik.show','periodik.edit','periodik.update',
'periodik.destroy','ptk.index','ptk.create','ptk.store','ptk.show',
'ptk.edit','ptk.update','ptk.destroy','beasiswa.index','beasiswa.create',
'beasiswa.store','beasiswa.show','beasiswa.edit','beasiswa.update','beasiswa.destroy',
'prestasi.index','prestasi.create','prestasi.store','prestasi.show','prestasi.edit',
'prestasi.update','prestasi.destroy','orang-tua.index','orang-tua.create','orang-tua.store',
'orang-tua.show','orang-tua.edit','orang-tua.update','orang-tua.destroy','registrasi-siswa.index',
'registrasi-siswa.create','registrasi-siswa.store','registrasi-siswa.show','registrasi-siswa.edit','registrasi-siswa.update',
'registrasi-siswa.destroy','kesejahteraan-siswa.index','kesejahteraan-siswa.create','kesejahteraan-siswa.store','kesejahteraan-siswa.show',
'kesejahteraan-siswa.edit','kesejahteraan-siswa.update','kesejahteraan-siswa.destroy','pendaftaran-keluar.index','pendaftaran-keluar.create',
'pendaftaran-keluar.store','pendaftaran-keluar.show','pendaftaran-keluar.edit','pendaftaran-keluar.update','pendaftaran-keluar.destroy',
'rayon.index','rayon.create','rayon.store','rayon.show','rayon.edit',
'rayon.update','rayon.destroy','jurusan.index','jurusan.create','jurusan.store',
'jurusan.show','jurusan.edit','jurusan.update','jurusan.destroy','rombel.index',
'rombel.create','rombel.store','rombel.show','rombel.edit','rombel.update',
'rombel.destroy','semester.index','semester.create','semester.store','semester.show',
'semester.edit','semester.update','semester.destroy','pendidikan-ptk.index','pendidikan-ptk.create',
'pendidikan-ptk.store','pendidikan-ptk.show','pendidikan-ptk.edit','pendidikan-ptk.update','pendidikan-ptk.destroy',
'kontak-ptk.index','kontak-ptk.create','kontak-ptk.store','kontak-ptk.show','kontak-ptk.edit',
'kontak-ptk.update','kontak-ptk.destroy','dokumen-ptk.index','dokumen-ptk.create','dokumen-ptk.store',
'dokumen-ptk.show','dokumen-ptk.edit','dokumen-ptk.update','dokumen-ptk.destroy','keluarga-ptk.index',
'keluarga-ptk.create','keluarga-ptk.store','keluarga-ptk.show','keluarga-ptk.edit','keluarga-ptk.update',
'keluarga-ptk.destroy','tunjangan.index','tunjangan.create','tunjangan.store','tunjangan.show',
'tunjangan.edit','tunjangan.update','tunjangan.destroy','kepegawaian-ptk.index','kepegawaian-ptk.create',
'kepegawaian-ptk.store','kepegawaian-ptk.show','kepegawaian-ptk.edit','kepegawaian-ptk.update','kepegawaian-ptk.destroy',
'kesejahteraan-ptk.index','kesejahteraan-ptk.create','kesejahteraan-ptk.store','kesejahteraan-ptk.show','kesejahteraan-ptk.edit',
'kesejahteraan-ptk.update','kesejahteraan-ptk.destroy','beasiswa-ptk.index','beasiswa-ptk.create','beasiswa-ptk.store',
'beasiswa-ptk.show','beasiswa-ptk.edit','beasiswa-ptk.update','beasiswa-ptk.destroy','sertifikat-ptk.index',
'sertifikat-ptk.create','sertifikat-ptk.store','sertifikat-ptk.show','sertifikat-ptk.edit','sertifikat-ptk.update',
'sertifikat-ptk.destroy','penugasan-ptk.index','penugasan-ptk.create','penugasan-ptk.store','penugasan-ptk.show',
'penugasan-ptk.edit','penugasan-ptk.update','penugasan-ptk.destroy','kompetensi-ptk.index','kompetensi-ptk.create',
'kompetensi-ptk.store','kompetensi-ptk.show','kompetensi-ptk.edit','kompetensi-ptk.update','kompetensi-ptk.destroy',
'kompetensi-khusus-ptk.index','kompetensi-khusus-ptk.create','kompetensi-khusus-ptk.store','kompetensi-khusus-ptk.show','kompetensi-khusus-ptk.edit',
'kompetensi-khusus-ptk.update','kompetensi-khusus-ptk.destroy','anak-ptk.index','anak-ptk.create','anak-ptk.store',
'anak-ptk.show','anak-ptk.edit','anak-ptk.update','anak-ptk.destroy','akun-ptk.index',
'akun-ptk.create','akun-ptk.store','akun-ptk.show','akun-ptk.edit','akun-ptk.update',
'akun-ptk.destroy','riwayat-karir.index','riwayat-karir.create','riwayat-karir.store','riwayat-karir.show',
'riwayat-karir.edit','riwayat-karir.update','riwayat-karir.destroy','penghargaan.index','penghargaan.create',
'penghargaan.store','penghargaan.show','penghargaan.edit','penghargaan.update','penghargaan.destroy',
'nilai-test.index','nilai-test.create','nilai-test.store','nilai-test.show','nilai-test.edit',
'nilai-test.update','nilai-test.destroy','diklat.index','diklat.create','diklat.store',
'diklat.show','diklat.edit','diklat.update','diklat.destroy','riwayat-jabatan.index',
'riwayat-jabatan.create','riwayat-jabatan.store','riwayat-jabatan.show','riwayat-jabatan.edit','riwayat-jabatan.update',
'riwayat-jabatan.destroy','riwayat-kepangkatan.index','riwayat-kepangkatan.create','riwayat-kepangkatan.store','riwayat-kepangkatan.show',
'riwayat-kepangkatan.edit','riwayat-kepangkatan.update','riwayat-kepangkatan.destroy','riwayat-gaji.index','riwayat-gaji.create',
'riwayat-gaji.store','riwayat-gaji.show','riwayat-gaji.edit','riwayat-gaji.update','riwayat-gaji.destroy',
'tugas-tambahan.index','tugas-tambahan.create','tugas-tambahan.store','tugas-tambahan.show','tugas-tambahan.edit',
'tugas-tambahan.update','tugas-tambahan.destroy','riwayat-jabatan-fungsional.index','riwayat-jabatan-fungsional.create','riwayat-jabatan-fungsional.store',
'riwayat-jabatan-fungsional.show','riwayat-jabatan-fungsional.edit','riwayat-jabatan-fungsional.update','riwayat-jabatan-fungsional.destroy','storage.local',);
        registerArgumentsSet('views', 
'akun-ptk.create','akun-ptk.edit','akun-ptk.index','akun-siswa.create','akun-siswa.edit',
'akun-siswa.index','anak-ptk.create','anak-ptk.edit','anak-ptk.index','anak-ptk.show',
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','beasiswa-ptk.create','beasiswa-ptk.edit','beasiswa-ptk.index','beasiswa-ptk.show',
'beasiswa.create','beasiswa.edit','beasiswa.index','beasiswa.show','diklat.create',
'diklat.edit','diklat.index','diklat.show','dokumen-ptk.create','dokumen-ptk.edit',
'dokumen-ptk.index','dokumen-ptk.show','dokumen-siswa.create','dokumen-siswa.edit','dokumen-siswa.index',
'dokumen-siswa.show','home','jurusan.create','jurusan.edit','jurusan.index',
'keluarga-ptk.create','keluarga-ptk.edit','keluarga-ptk.index','kepegawaian-ptk.create','kepegawaian-ptk.edit',
'kepegawaian-ptk.index','kesejahteraan-ptk.create','kesejahteraan-ptk.edit','kesejahteraan-ptk.index','kesejahteraan-ptk.show',
'kesejahteraan-siswa.create','kesejahteraan-siswa.edit','kesejahteraan-siswa.index','kesejahteraan-siswa.show','kompetensi-khusus-ptk.create',
'kompetensi-khusus-ptk.edit','kompetensi-khusus-ptk.index','kompetensi-khusus-ptk.show','kompetensi-ptk.create','kompetensi-ptk.edit',
'kompetensi-ptk.index','kompetensi-ptk.show','kontak-ptk.create','kontak-ptk.edit','kontak-ptk.index',
'kontak-siswa.create','kontak-siswa.edit','kontak-siswa.index','layouts.app','nilai-test.create',
'nilai-test.edit','nilai-test.index','nilai-test.show','orang-tua.create','orang-tua.edit',
'orang-tua.index','pendaftaran-keluar.create','pendaftaran-keluar.edit','pendaftaran-keluar.index','pendidikan-ptk.create',
'pendidikan-ptk.edit','pendidikan-ptk.index','pendidikan-ptk.show','penghargaan.create','penghargaan.edit',
'penghargaan.index','penghargaan.show','penugasan-ptk.create','penugasan-ptk.edit','penugasan-ptk.index',
'periodik.create','periodik.edit','periodik.index','prestasi.create','prestasi.edit',
'prestasi.index','prestasi.show','profile.index','ptk.create','ptk.edit',
'ptk.index','rayon.Index','rayon.create','rayon.edit','registrasi-siswa.create',
'registrasi-siswa.edit','registrasi-siswa.index','riwayat-gaji.create','riwayat-gaji.edit','riwayat-gaji.index',
'riwayat-gaji.show','riwayat-jabatan-fungsional.create','riwayat-jabatan-fungsional.edit','riwayat-jabatan-fungsional.index','riwayat-jabatan-fungsional.show',
'riwayat-jabatan.create','riwayat-jabatan.edit','riwayat-jabatan.index','riwayat-jabatan.show','riwayat-karir.create',
'riwayat-karir.edit','riwayat-karir.index','riwayat-karir.show','riwayat-kepangkatan.create','riwayat-kepangkatan.edit',
'riwayat-kepangkatan.index','riwayat-kepangkatan.show','rombel.create','rombel.edit','rombel.index',
'semester.create','semester.edit','semester.index','sertifikat-ptk.create','sertifikat-ptk.edit',
'sertifikat-ptk.index','sertifikat-ptk.show','siswa.create','siswa.edit','siswa.index',
'tugas-tambahan.create','tugas-tambahan.edit','tugas-tambahan.index','tugas-tambahan.show','tunjangan.create',
'tunjangan.edit','tunjangan.index','tunjangan.show','welcome','laravel-exceptions-renderer::components.badge',
...
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','D:.PKL.project.sidata.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
